...
function my_log($string){
    $log_file_name = $_SERVER['DOCUMENT_ROOT']."/my_log_3.txt";
...
function passwordLen($a) {
    if(strlen($a)<=4) {
      throw new Exception('The password contains too few characters', 512);
    }
}

passwordLen("fl;flddfld");
passwordLen("abc");
